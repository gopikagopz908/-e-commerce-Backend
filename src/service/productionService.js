...
export const deleteProductService = async (id) => {
  ...
  return await Product.findByIdAndUpdate(
    id,
    { isDelete: true },
    { new: true } //soft delete bcz instead of permanently deleting the product from the db
  );
};
